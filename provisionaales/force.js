...
function loadData(json) {
  ...
  var node = svg.selectAll("circle.node")
      ...
      .enter().append("circle")
      .attr("class", "node")
      .attr("r", function(d) { return getrank(d.puntos)*2; } )
      .style("fill", function(d) { return getcolor(d.puntos); });
      // .on("hover",function(d) { 
  ...
  //       .attr("y2", function(d) { return d.target.y; });
     ...
     node.attr("x", function(d) { return d.x*2; })
         .attr("y", function(d) { return d.y/2; })
         .attr("cx", function(d) { return d.x; })
         .attr("cy", function(d) { return d.y; })
         
     node.append("title")
         .text(function(d) { return d.equipo+" : "+d.puntos+"  puntos  "; })
         .attr("cx", function(d) { return d.x; })
         .attr("cy", function(d) { return d.y; });
